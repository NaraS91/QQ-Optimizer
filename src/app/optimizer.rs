use egui::{self, Rounding, Margin};
use crate::app::COLOR_PALLET;

use self::{optimize::Optimize, team::Team};

use super::{light_cones_store::{self, LightConesStore}, relics_store::{self, RelicsStore}, units_store::{self, UnitsStore}};
...
pub fn new_page(ui: &mut egui::Ui, optimizer: &mut Box<Optimizer>, relics_store: &mut RelicsStore, units_store: &mut UnitsStore, light_cones_store: &mut LightConesStore) {
    ...
    let menu_state = egui::CentralPanel::default()
        ...
        .show_inside(ui, |ui| {
            ...
            match &mut optimizer.menu_state {
                ...
                Menu::Optimize => optimizer.optimize.show_ui(ui, relics_store, units_store, light_cones_store)
            }
